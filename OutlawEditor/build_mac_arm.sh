...
echo "Building native executable for macOS ARM64..."
mvn clean package
mvn gluonfx:build

# Create .app bundle structure
APP_DIR="target/gluonfx/aarch64-darwin/OutlawEditor.app"
echo "Creating .app bundle structure..."
mkdir -p "$APP_DIR/Contents/MacOS"
mkdir -p "$APP_DIR/Contents/Resources"

# Copy executable into bundle
cp target/gluonfx/aarch64-darwin/outlaweditor "$APP_DIR/Contents/MacOS/"
...
DMG_NAME="OutlawEditor-3.0-macOS-arm64.dmg"
...
cp "target/gluonfx/aarch64-darwin/$DMG_NAME" ./
